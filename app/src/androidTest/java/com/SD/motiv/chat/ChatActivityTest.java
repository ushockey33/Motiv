...
public class ChatActivityTest {
    ...
    public void channelNameIsShownInToolbar() throws Exception {
        givenChatIsEmpty();
        launchChatActivityWithAccess(Channel.Access.PRIVATE);
    ...
    public void cannotManageUsersInPublicChannel() throws Exception {
        givenChatIsEmpty();
        launchChatActivityWithAccess(Channel.Access.PUBLIC);
    ...
    private void launchChatActivityWithAccess(Channel.Access access) {
